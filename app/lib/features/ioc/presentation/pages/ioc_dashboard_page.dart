    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildStatCard('Usuarios Activos', '3', Icons.people, DesignTokens.safeGreen),
              const SizedBox(width: 16),
              _buildStatCard('Activos Registrados', '12', Icons.inventory, DesignTokens.govBlue),
              const SizedBox(width: 16),
              _buildStatCard('Violaciones SoD', '0', Icons.warning, DesignTokens.safetyRed),
              const SizedBox(width: 16),
              _buildStatCard('Última Auditoría', 'Hoy', Icons.history, DesignTokens.warningYellow),
            ],
          ),
  ...
  Widget _buildActivityItem(String user, String action, String time) {
    return ListTile(
      leading: CircleAvatar(
        backgroundColor: DesignTokens.govBlue.withOpacity(0.1),
        child: Text(
        ...
        children: [
          ...
          Expanded(
            ...
            child: Icon(
              ...
              color: user['active'] ? DesignTokens.safeGreen : DesignTokens.safetyRed,
            ),
          ),
          ...
          Expanded(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.delete, size: 20, color: DesignTokens.safetyRed),
                  onPressed: () {
                    // TODO: Delete user
                  },
                  tooltip: 'Eliminar',
