        ...
        children: [
          ...
          LinearProgressIndicator(
            ...
            valueColor: AlwaysStoppedAnimation<Color>(
              _allCriticalCompleted ? Color(DesignTokens.safeGreen) : Color(DesignTokens.warningYellow),
            ),
            minHeight: 8,
          ),
          ...
          if (!_allCriticalCompleted)
            Container(
              ...
              color: Color(DesignTokens.warningYellow).withOpacity(0.2),
              child: Row(
                children: [
                  Icon(Icons.warning, color: Color(DesignTokens.warningYellow)),
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: item.isCompleted 
                  ? Color(DesignTokens.safeGreen)
                  : item.isCritical 
                      ? Color(DesignTokens.safetyRed).withOpacity(0.5)
                      : Colors.grey.withOpacity(0.3),
              width: item.isCompleted ? 2 : 1,
            ),
            color: item.isCompleted 
                ? Color(DesignTokens.safeGreen).withOpacity(0.05)
                : null,
          ),
          child: Row(
            children: [
              ...
              Container(
                ...
                child: item.isCompleted
                    ...
                    : item.isCritical
                        ? Icon(Icons.star, color: Color(DesignTokens.safetyRed), size: 24)
                        : null,
              ),
              const SizedBox(width: 16),
                      ...
                      children: [
                        ...
                        if (item.isCritical)
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color(DesignTokens.safetyRed).withOpacity(0.1),
                            ...
                            child: const Text(
                              ...
                              style: TextStyle(
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                                color: Color(DesignTokens.safetyRed),
                              ),
                            ),
                          ),
                      ],
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  ...
                  backgroundColor: Color(DesignTokens.safeGreen),
                ),
              );
            },
            style: ElevatedButton.styleFrom(
