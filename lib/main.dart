                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(DesignTokens.govBlue).withOpacity(0.1),
                      ...
                      if (state is AuthError) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            backgroundColor: const Color(DesignTokens.safetyRed),
                          ),
                        );
                      }
                    },
                      ...
                      return SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(DesignTokens.govBlue),
